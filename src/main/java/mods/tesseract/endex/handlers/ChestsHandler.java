...
public class ChestsHandler {
    ...
    private static LootPool getInjectPool(String entryName) {
        return new LootPool(new LootEntry[] {getInjectEntry(entryName)}, new LootCondition[0], new RandomValueRange(1), new RandomValueRange(0, 1), "endex_inject_pool");
    }

    private static LootEntryTable getInjectEntry(String name) {
        return new LootEntryTable(new ResourceLocation(Reference.MODID, "inject/" + name), 1, 0, new LootCondition[0], "endex_inject_entry");
    }
}