...
import mods.tesseract.endex.utils.EndUtils;
import mods.tesseract.endex.world.EndVillagerHouse;
...
public class EndVillagerHandler
{
	...
	{
		PROF_EXPLORER = new VillagerRegistry.VillagerProfession(Reference.MODID+":explorer", "endex:textures/models/villager_explorer.png", "endex:textures/models/villager_explorer_zombie.png");
